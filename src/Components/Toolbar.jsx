...
const Toolbar = () => {
  ...
  return (
    <div className="w-full bg-gradient-to-r from-slate-700 via-slate-600 to-slate-700 text-white overflow-hidden py-2 border-b border-slate-500/30 shadow-sm">
